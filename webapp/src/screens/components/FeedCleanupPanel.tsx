...
const config: CleanupConfig<FeedCleanupReview> = {
  ...
  resultConfirmed: "Reviewed friend update data and backups cleared on this node. Friendships and independently saved copies remain. Remote devices confirmed.",
