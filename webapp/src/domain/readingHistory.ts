...
export function contentFromHistory(record: ConsumptionRecord): ContentItem {
  ...
  return {
    ...
    content_kind: item.content_kind as ContentItem["content_kind"], content_type: item.content_type,
