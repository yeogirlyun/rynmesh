...
const errors: Record<string, string> = {
  ...
  sync_verification_code_mismatch: "The code you entered does not match the code shown for this device. Compare the codes on both computers and try again.",
...
export const deviceSyncApi = {
  ...
  approve: (pair: DevicePair, scopes: SyncScope[], verificationCode: string) => request<DevicePair>(devicePath(pair.id, "approve"), "POST", { review_token: pair.review_token, scopes, verification_code: verificationCode }),
