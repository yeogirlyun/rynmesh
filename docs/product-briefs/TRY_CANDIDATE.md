...
| 两人分享 | Friends | 创建邀请、接受、分享正文或附件、查看送达、撤销 | 已安装包的两节点页面邀请、消息、正文及撤销已验证；macOS 安装邀请和公网待验 |
...
| 自己的多设备同步 | Settings → My devices | 配对自己的设备，选择同步范围，处理冲突并继续阅读 | 已安装包的双端审核和收藏同步已验证；实际多设备及完整范围、跨网待验 |
